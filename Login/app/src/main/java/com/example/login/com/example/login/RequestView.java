...
public class RequestView extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Request_no=bundle.getString("RequestNo");
        String Request_date=bundle.getString("RequestDate");
        String Request_status=bundle.getString("RequestStatus");
        ...
        textView.setText(Request_no);
        textView1.setText(Request_date);
        textView2.setText(Request_status);
